            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        { chirp.created_at !== chirp.updated_at && <small className="text-sm text-gray-600"> &middot; modifiée</small>}
                    </div>
                ...
                {editing
                    ? <form onSubmit={submit}>
                        ...
                        <div className="space-x-2">
                            <PrimaryButton className="mt-4">Enregistrer</PrimaryButton>
                            <button className="mt-4" onClick={() => setEditing(false) && reset()}>Annuler</button>
                        </div>
                    </form>
